...
void MapEdit_smooth_selection(MapEditContext const *map,
                              struct MapEditSelection *selected,
                              struct MapTexGroups *groups_data,
                              _Optional struct MapEditChanges *change_info);

void MapEdit_flood_fill(MapEditContext const *map,
                        MapRef replace, MapPoint map_pos,
                        _Optional struct MapEditChanges *change_info);
...
void MapEdit_write_tile(MapEditContext const *map, MapPoint map_pos,
  MapRef tile_num, _Optional struct MapEditChanges *change_info);
...
void MapEdit_copy_to_area(MapEditContext const *map,
                          MapArea const *area,
                          MapEditReadFn *read, void *cb_arg,
                          _Optional struct MapEditChanges *change_info);
